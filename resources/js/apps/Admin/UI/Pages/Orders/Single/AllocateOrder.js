...
export default function AllocateOrder(){
    ...
    const profit = useOrderMetricsProfit(order.price_raw, data.writer_price)
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-12 col-xl-4">
                                    <div className="form-group mb-xl-0">
                                        ...
                                        <input placeholder={order.price} className="form-control" type="number" value={data.writer_price} onChange={(e) => setData({...data, writer_price: e.target.value})} required />
                                        {
